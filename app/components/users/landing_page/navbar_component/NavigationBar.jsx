            ...
            <div>
                <nav className="  grid grid-cols-12      px-5 py-2">
                    ...
                    <div className="col-span-12 lg:col-span-5 md:col-span-7 sm:col-span-12  text-center flex pt-2 justify-evenly" >
                        <div onClick={()=>{navigate('/')}} className="text-[16px] hover:text-[17px]  text-black hover:text-orange-400 cursor-pointer hover:underline decoration-2 underline-offset-8 hover:font-[600]">
                            Home  
                        </div>
